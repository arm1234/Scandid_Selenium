...
public class Test7_1_ComparePricesButton extends BusinessFunctions{
	...
	Thread.sleep(10000);
    driver.findElement(By.cssSelector("a.coupon-anch-link.scroll-to > span")).click();
	Thread.sleep(20000);
	
	Reporter.log("\nCompare Prices Button is working fine.",true);
