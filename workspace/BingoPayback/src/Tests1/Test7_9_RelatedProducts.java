...
public class Test7_9_RelatedProducts extends BusinessFunctions{
	...
	driver.findElement(By.linkText("Micromax phone prices in India")).click();
	Thread.sleep(20000);
	
    		
	Reporter.log("\nRelated Products link is working fine",true);
