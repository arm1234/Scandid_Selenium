...
public class Test7_4_AddToWishlistButton extends BusinessFunctions{
	...
	Thread.sleep(10000);
	driver.findElement(By.id("couponsubscribe11")).click();
	Thread.sleep(10000);
    driver.findElement(By.cssSelector("#overlay_loginpopup > a.overlay-close")).click();
	Thread.sleep(10000);
	
	Reporter.log("\nAdd to Wishlist button is working fine.",true);
