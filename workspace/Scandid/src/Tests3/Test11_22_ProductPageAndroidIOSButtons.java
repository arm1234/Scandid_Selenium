...
public class Test11_22_ProductPageAndroidIOSButtons extends BusinessFunctions {
  ...
  public void test() throws Exception {
	...
	//Check if On Product Page, Android, IOS, Chrome buttons are working fine 
	...
	Reporter.log("On Product Page, Android, IOS, Chrome buttons are working fine.",true);
