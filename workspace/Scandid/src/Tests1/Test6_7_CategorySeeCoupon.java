...
public class Test6_7_CategorySeeCoupon extends BusinessFunctions {
  ...
  public void test() throws Exception {
    ...
    //Check if Category See Coupon Button is clickable
	...
	Thread.sleep(20000);
    Reporter.log("Category See Coupon Button is clickable.",true);
